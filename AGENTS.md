...
- For training advice, use the returned Recovery Load, recovery days and workout capacity fields directly. Do not reimplement Xert's recovery-days formula locally.

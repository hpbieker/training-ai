...
TOOL_DEFINITIONS: dict[str, dict[str, object]] = {
    ...
    "solve_segment_duration": {
        ...
        "inputSchema": {"type": "object", "properties": {
            ...
            "minimum_duration_seconds": {"type": "integer", "minimum": 0, "default": 0, "description": "Minimum adjustable duration; zero omits the adjustable segment."},
            "maximum_duration_seconds": {"type": "integer", "minimum": 0, "default": 28800, "description": "Maximum adjustable duration."},
